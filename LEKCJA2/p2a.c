...
- co by się stało gdyby wątek zakończył działanie w czasie wykonywania
   funkcji wypisz (sprawdzić) - bez stosu - deadlock

 - dzieki cleanup_push i pop funkcja wypisz jest odporna na nagle przerwanie
 - doda na stos i w razie przerwania mutex zostanie odblokowany
 - gdy przerwanie nie wystapi stos zostanie wyczyszczoy dzieki pop(0)
