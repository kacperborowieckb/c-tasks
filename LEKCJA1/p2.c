...
Zwroć uwagę:
a) jak jest przekazywana wartość całkowita do funkcji wątku. - mapowanie na (void *)
b) jak ustalić atrybut tworzonego wątku - pthread_attr_t i pthread_attr_init(&attr), pozniej pthread_attr_set...
